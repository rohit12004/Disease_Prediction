...
## 📌 Overview
The **Disease Prediction Project** is designed to develop machine learning models that can predict various diseases based on patient data and symptoms. It includes models for:
...
- **Probability Display**: Shows the probability that the predicted disease is correct.

---

## 🤖 Models Used

- **Diabetes Prediction**: Based on the PIMA Diabetes dataset.
- **CKD Prediction**: Based on the CKD dataset.
- **Heart Disease Prediction**: Based on the Heart Disease dataset.
- **Parkinson's Prediction**: Based on the Parkinson's dataset.
- **Liver Disease Prediction**: Based on the Liver Disease dataset.

---

# 🧪 Disease Prediction Inputs

Below is the list of input features required for each disease model:
